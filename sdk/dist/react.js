...
var __defProp2, __defNormalProp, __require, __publicField, U32_MASK64, _32n, rotlSH, rotlSL, rotlBH, rotlBL, isLE, swap32IfBE, hasHexBuiltin, hexes, asciis, Hash, _0n, _1n, _2n, _7n, _256n, _0x71n, SHA3_PI, SHA3_ROTL, _SHA3_IOTA, IOTAS, SHA3_IOTA_H, SHA3_IOTA_L, rotlH, rotlL, Keccak, gen, keccak_256, HMAC, hmac, HashMD, SHA256_IV, SHA256_K, SHA256_W, SHA256, sha256, secp256k1_CURVE, P, N, Gx, Gy, _b, L, L2, err, isBig, isStr, isBytes2, abytes2, u8n, u8fr, padh, bytesToHex2, C, _ch, hexToBytes2, toU8, cr, subtle, concatBytes, randomBytes, big, arange, M, modN, invert, callHash, apoint, koblitz, afield0, afield, agroup, isEven, u8of, getPrefix, lift_x, _Point, Point, G, I, doubleScalarMulUns, bytesToNumBE, sliceBytesNumBE, B256, numTo32b, toPrivScalar, highS, Signature, bits2int, bits2int_modN, signOpts, prepSig, hmacDrbg, sign, recoverPublicKey, hashToPrivateKey, _sha, etc, W, scalarBits, pwindows, pwindowSize, precompute, Gpows, ctneg, wNAF, isServerEnvironment, DEFAULT_TTL_SEC, RP_SIGNATURE_MSG_VERSION, ETHEREUM_MESSAGE_PREFIX, textEncoder;
var init_dist = __esm({
  "../node_modules/@worldcoin/idkit-server/dist/index.js"() {
    "use strict";
    ...
    bits2int_modN = (bytes) => modN(bits2int(abytes2(bytes)));
    signOpts = { lowS: true };
    prepSig = (msgh, priv, opts = signOpts) => {
    ...
    ETHEREUM_MESSAGE_PREFIX = "Ethereum Signed Message:\n";
...
async function __wbg_init(module_or_path) {
  ...
  if (module_or_path === void 0) {
    module_or_path = new URL("idkit_wasm_bg.wasm", import_meta.url);
  }
  const imports = __wbg_get_imports();
...
var import_meta, __defProp3, __export2, IDKitErrorCodes, idkit_wasm_exports, BridgeEncryption, CredentialRequestWasm, IDKitBuilder, IDKitProof, IDKitRequest, RpContextWasm, RpSignature, __wbindgen_enum_RequestCache, __wbindgen_enum_RequestCredentials, __wbindgen_enum_RequestMode, BridgeEncryptionFinalization, CredentialRequestWasmFinalization, IDKitBuilderFinalization, IDKitProofFinalization, IDKitRequestFinalization, RpContextWasmFinalization, RpSignatureFinalization, CLOSURE_DTORS, cachedDataViewMemory0, cachedUint8ArrayMemory0, heap, heap_next, cachedTextDecoder, MAX_SAFARI_DECODE_BYTES, numBytesDecoded, cachedTextEncoder, WASM_VECTOR_LEN, wasm, wasmInitialized, wasmInitPromise, _debug, MINIAPP_VERIFY_ACTION, _requestCounter, _activeNativeRequest, NativeIDKitRequest, SESSION_ID_PATTERN, IDKitRequestImpl, IDKitBuilder2, IDKit;
var init_dist2 = __esm({
  "../node_modules/@worldcoin/idkit-core/dist/index.js"() {
    ...
    IDKitErrorCodes = /* @__PURE__ */ ((IDKitErrorCodes2) => {
    ...
    CredentialRequestWasm = class _CredentialRequestWasm {
      static __wrap(ptr) {
        ptr = ptr >>> 0;
    ...
    IDKitBuilder = class _IDKitBuilder {
      static __wrap(ptr) {
        ptr = ptr >>> 0;
    ...
    IDKitRequest = class _IDKitRequest {
      static __wrap(ptr) {
        ptr = ptr >>> 0;
    ...
    RpSignature = class _RpSignature {
      static __wrap(ptr) {
        ptr = ptr >>> 0;
    ...
    BridgeEncryptionFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
    }, unregister: () => {
    } } : new FinalizationRegistry((ptr) => wasm.__wbg_bridgeencryption_free(ptr >>> 0, 1));
    CredentialRequestWasmFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
    }, unregister: () => {
    } } : new FinalizationRegistry((ptr) => wasm.__wbg_credentialrequestwasm_free(ptr >>> 0, 1));
    IDKitBuilderFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
    }, unregister: () => {
    } } : new FinalizationRegistry((ptr) => wasm.__wbg_idkitbuilder_free(ptr >>> 0, 1));
    IDKitProofFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
    }, unregister: () => {
    } } : new FinalizationRegistry((ptr) => wasm.__wbg_idkitproof_free(ptr >>> 0, 1));
    IDKitRequestFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
    }, unregister: () => {
    } } : new FinalizationRegistry((ptr) => wasm.__wbg_idkitrequest_free(ptr >>> 0, 1));
    RpContextWasmFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
    }, unregister: () => {
    } } : new FinalizationRegistry((ptr) => wasm.__wbg_rpcontextwasm_free(ptr >>> 0, 1));
    RpSignatureFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
    }, unregister: () => {
    ...
    wasmInitPromise = null;
    _debug = false;
    MINIAPP_VERIFY_ACTION = "miniapp-verify-action";
    _requestCounter = 0;
    _activeNativeRequest = null;
    NativeIDKitRequest = class {
    ...
    SESSION_ID_PATTERN = /^session_[0-9a-fA-F]{128}$/;
    IDKitRequestImpl = class {
...
__export(dist_exports, {
  ...
  IDKitRequestWidget: () => IDKitRequestWidget,
  IDKitSessionWidget: () => IDKitSessionWidget,
  all: () => all,
  any: () => any,
  deviceLegacy: () => deviceLegacy,
  documentLegacy: () => documentLegacy,
  enumerate: () => enumerate,
  isDebug: () => isDebug,
  orbLegacy: () => orbLegacy,
  secureDocumentLegacy: () => secureDocumentLegacy,
  selfieCheckLegacy: () => selfieCheckLegacy,
  setDebug: () => setDebug,
  signRequest: () => signRequest,
  useIDKitRequest: () => useIDKitRequest,
  useIDKitSession: () => useIDKitSession
});
...
function useIDKitFlow(createFlowHandle, config) {
  const isInWorldApp$1 = (0, import_react.useMemo)(() => isInWorldApp(), []);
  const [state, setState] = (0, import_react.useState)(
    createInitialHookState
  );
  const [runId, setRunId] = (0, import_react.useState)(0);
  const abortRef = (0, import_react.useRef)(null);
  const createFlowHandleRef = (0, import_react.useRef)(createFlowHandle);
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "section",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "idkit-content", children }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", { className: "idkit-footer", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "a",
                {
...
function IDKitModal({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ModalContent, { onOpenChange, children });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShadowHost, { children: content });
}
function useMedia() {
  ...
  const [media, setMedia] = (0, import_react.useState)(getInitialState);
  (0, import_react.useEffect)(() => {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "linearGradient",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: ".37", stopColor: "#fff", stopOpacity: "0" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: ".5", stopColor: "#fff", stopOpacity: ".85" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: ".63", stopColor: "#fff", stopOpacity: "0" })
            ]
          }
        ) })
      ]
...
function QRState({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "idkit-mobile-only", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", { href: qrData ?? void 0, className: "idkit-deeplink-btn", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WorldcoinIcon, {}),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: __("Open World App") })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "idkit-desktop-only", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: __("QR Code copied") })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "idkit-qr-wrapper", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "idkit-qr-inner", children: qrData ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "div",
        {
          onClick: copyLink,
          onKeyDown: (e) => {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QRCode, { data: qrData, size: media === "mobile" ? 160 : 200 })
        }
      ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "idkit-qr-placeholder", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QRPlaceholderIcon, {}) }) }) }),
      showSimulatorCallout && qrData && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "idkit-simulator-callout", children: [
        "Testing in staging?",
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "a",
...
function WorldIDState({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "idkit-worldid-icon", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WorldcoinIcon, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "idkit-heading", children: __("Connect your World ID") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "idkit-subtext", children: media === "mobile" ? __(
          "You will be redirected to the app, please return to this page once you're done"
        ) : __("Use phone camera to scan the QR code") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "idkit-qr-container", children: [
          isAwaitingUserConfirmation && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "idkit-qr-overlay", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "idkit-spinner", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingIcon, {}) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "idkit-connecting-text", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: __("Connecting...") }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: __("Please continue in app") })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                QRState,
                {
                  qrData: connectorURI,
                  showSimulatorCallout
...
function CheckIcon(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "svg",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { width: "88", height: "88", rx: "44", fill: "#00C230" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "rect",
          {
            opacity: "0.2",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M29.5 45.5L37.5 53.5L57.5 33.5", stroke: "white", strokeWidth: "3" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "radialGradient",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "1", stopColor: "white", stopOpacity: "0" })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "linearGradient",
            {
              ...
              gradientUnits: "userSpaceOnUse",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { stopColor: "white", stopOpacity: "0.3" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "1", stopColor: "white", stopOpacity: "0" })
              ]
            }
          )
...
function SuccessState() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "idkit-success-icon", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckIcon, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "idkit-heading", children: __("All set!") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "idkit-subtext", style: { maxWidth: 260 }, children: __("Your World ID is now connected") })
      ]
    }
  );
}
function ErrorIcon(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "svg",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { width: "88", height: "88", rx: "44", fill: "#9BA3AE" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "rect",
          {
            opacity: "0.2",
...
function WarningIcon(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "svg",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { width: "88", height: "88", rx: "44", fill: "#FFAE00" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "rect",
          {
            opacity: "0.2",
...
function ErrorState({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "idkit-error-icon", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "idkit-error-title", children: __(title) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "idkit-error-message", children: __(message) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "idkit-retry-btn", onClick: handleAction, children: __(actionLabel) })
      ]
    }
  );
}
function HostAppVerificationState({ onVerify }) {
  const calledRef = (0, import_react.useRef)(false);
  (0, import_react.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "idkit-spinner", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingIcon, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "idkit-subtext", children: __("Transmitting verification to host app. Please wait...") })
      ]
    }
  );
}
...
function IDKitWidgetBase({
  ...
  const [hostVerifyResult, setHostVerifyResult] = (0, import_react.useState)(null);
  const lastResultRef = (0, import_react.useRef)(null);
  const lastErrorCodeRef = (0, import_react.useRef)(null);
  const verifyGenRef = (0, import_react.useRef)(0);
  (0, import_react.useEffect)(() => {
    if (language) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(IDKitModal, { open, onOpenChange, children: [
    stage === "worldid" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      WorldIDState,
      {
    ...
    stage === "host_verification" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    stage === "success" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SuccessState, {}),
    stage === "error" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ErrorState,
      {
...
var import_react, import_react_dom, import_jsx_runtime, import_qrcode, knownErrorCodes, SESSION_ID_PATTERN2, WIDGET_STYLES, en, es, th, translations, currentConfig, setLocalizationConfig, getLocalizationConfig, detectBrowserLanguage, getCurrentLanguage, getTranslations, getLang, replaceParams, generateMatrix, QRCode, errorCodeVariants, variantConfig;
var init_dist3 = __esm({
  "../node_modules/@worldcoin/idkit/dist/index.js"() {
    ...
    knownErrorCodes = new Set(Object.values(IDKitErrorCodes));
    SESSION_ID_PATTERN2 = /^session_[0-9a-fA-F]{128}$/;
    WIDGET_STYLES = `
@font-face {
...
`;
    ...
    getLocalizationConfig = () => currentConfig;
    ...
    QRCode = (0, import_react.memo)(QRCodeInner);
    errorCodeVariants = {
...
function HumanAuth({
  ...
  const [rpContext, setRpContext] = (0, import_react2.useState)(null);
  const [idkitModule, setIdkitModule] = (0, import_react2.useState)(null);
  ...
  async function loadIdkit() {
    try {
      const mod = await Promise.resolve().then(() => (init_dist3(), dist_exports));
      setIdkitModule({
  ...
  const handleSuccess = (0, import_react2.useCallback)(
    async (result) => {
      setLoading(true);
      try {
        let proof;
        ...
        if (!verifyRes.ok) {
          const err2 = await verifyRes.json().catch(() => ({ error: "Verification failed" }));
          throw new Error(err2.error || "Verification failed");
        }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "button",
    {
      ...
      children: loading ? "Verifying..." : !rpContext ? "Loading..." : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" }) }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "button",
      {
        ...
        children: loading ? "Verifying..." : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" }) }),
          children || "Verify with World ID"
        ] })
      }
